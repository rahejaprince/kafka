...
class ShareCoordinatorServiceTest {
  ...
  private CoordinatorRuntime<ShareCoordinatorShard, Record> mockRuntime() {
    return (CoordinatorRuntime<ShareCoordinatorShard, Record>) mock(CoordinatorRuntime.class);
  }

  private ShareCoordinatorConfig createConfig() {
  ...
  public void testWriteStateSuccess() throws ExecutionException, InterruptedException, TimeoutException {
    ...
    when(runtime.scheduleWriteOperation(
        ...
        ArgumentMatchers.eq(new TopicPartition(SHARE_GROUP_STATE_TOPIC_NAME, 0)),
