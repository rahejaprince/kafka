...
public class ShareGroupCommandOptions extends CommandDefaultOptions {
    ...
    public static final String DESCRIBE_DOC = "Describe share group and list offset lag (number of messages not yet processed) related to given group.";
    ...
    public static final String DELETE_DOC = "Pass in groups to delete topic partition offsets and ownership information " +
            "over the entire share group. For instance --group g1 --group g2";
