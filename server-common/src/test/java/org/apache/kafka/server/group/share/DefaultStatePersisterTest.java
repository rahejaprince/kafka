...
class DefaultStatePersisterTest {
  ...
  public void testWriteStateSuccess() {
    ...
    String coordinatorKey1 = ShareGroupHelper.coordinatorKey(groupId, topicId1, partition1);
    String coordinatorKey2 = ShareGroupHelper.coordinatorKey(groupId, topicId2, partition2);
